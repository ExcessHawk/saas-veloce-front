...
const NAV_BY_ROLE = {
  director: [
    ...
    { path: '/dashboard/grade-levels',   label: 'Niveles de Grado', icon: ListOrdered,    prefetch: () => import('@/pages/GradeLevelsPage'),   prefetchQuery: () => queryClient.prefetchQuery({ queryKey: ['grade-levels'],   queryFn: () => api.get('/api/grade-levels?limit=200').then(r=>r.data.data)  }) },
